...
// ()->callback function
    ...
    //to get user who is creating post
    const user=JSON.parse(localStorage.getItem('profile'));
    // console.log("hi there I am ",user);
        ...
        return(
            <paper className={classes.paper} elevation={6}>
                <Typography variant="h6" align="center">
                    Please SignIn to create  memories as well as to like others memories!
                </Typography>
            </paper>
        );
    }
    ...
    //simple update now tag is a ChipInput instead of Textfield.
